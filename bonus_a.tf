...
locals {
  ...
  chewbacca_secret_arn_guess = "arn:aws:secretsmanager:${data.aws_region.chewbacca_region01.id}:${data.aws_caller_identity.chewbacca_self01.account_id}:secret:${local.chewbacca_prefix}/rds/mysql*"
}
...
resource "aws_vpc_endpoint" "chewbacca_vpce_s3_gw01" {
  vpc_id            = aws_vpc.chewbacca_vpc01.id
  service_name      = "com.amazonaws.${data.aws_region.chewbacca_region01.id}.s3"
...
resource "aws_vpc_endpoint" "chewbacca_vpce_ssm01" {
  vpc_id              = aws_vpc.chewbacca_vpc01.id
  service_name        = "com.amazonaws.${data.aws_region.chewbacca_region01.id}.ssm"
...
resource "aws_vpc_endpoint" "chewbacca_vpce_ec2messages01" {
  vpc_id              = aws_vpc.chewbacca_vpc01.id
  service_name        = "com.amazonaws.${data.aws_region.chewbacca_region01.id}.ec2messages"
  vpc_endpoint_type   = "Interface"
  private_dns_enabled = true
...
resource "aws_vpc_endpoint" "chewbacca_vpce_ssmmessages01" {
  vpc_id              = aws_vpc.chewbacca_vpc01.id
  service_name        = "com.amazonaws.${data.aws_region.chewbacca_region01.id}.ssmmessages"
  vpc_endpoint_type   = "Interface"
  private_dns_enabled = true
...
resource "aws_vpc_endpoint" "chewbacca_vpce_logs01" {
  vpc_id              = aws_vpc.chewbacca_vpc01.id
  service_name        = "com.amazonaws.${data.aws_region.chewbacca_region01.id}.logs"
  vpc_endpoint_type   = "Interface"
  private_dns_enabled = true
...
resource "aws_vpc_endpoint" "chewbacca_vpce_secrets01" {
  vpc_id              = aws_vpc.chewbacca_vpc01.id
  service_name        = "com.amazonaws.${data.aws_region.chewbacca_region01.id}.secretsmanager"
  vpc_endpoint_type   = "Interface"
  private_dns_enabled = true
...
resource "aws_vpc_endpoint" "chewbacca_vpce_kms01" {
  vpc_id              = aws_vpc.chewbacca_vpc01.id
  service_name        = "com.amazonaws.${data.aws_region.chewbacca_region01.id}.kms"
  vpc_endpoint_type   = "Interface"
  private_dns_enabled = true
